...
public class GetAreaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RectangleCalculator rectCalc = new RectangleCalculator(Double.parseDouble(length),Double.parseDouble(width));
		request.setAttribute("calcResult", rectCalc);
		getServletContext().getRequestDispatcher("/areaResult.jsp").forward(request, response);
	}
